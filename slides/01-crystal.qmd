...
So both the data and data dictionary are in the same file. So let's take 5 minutes to log into posit cloud and navigate to our data file. Then open and review both the data dictionary and the data to see what is actually going on in our file.
...
Notice that I am giving you a hint here that in this situation we want to use both the sheet and then skip arguments. I am not showing you the full code because we are going to do this in an exercise here in just a moment. But do pay attention to the quotation marks that are needed for the sheet argument. Those are not needed for the skip argument.
