...
2. In **Visual** mode, try a traditional keyboard shortcut to format text in Google Docs or Microsoft Word (`Cmd`/`Ctrl` + `B` to bold text).

3. Try out other formatting shortcuts you normally use.

4. Try inserting an image using the **Insert Anything** shortcut (`Cmd`/`Ctrl` + `/`).
