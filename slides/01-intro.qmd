...
![From left to right: Tai, Mai, and Skye](images/mts.webp){fig-alt="Three snowshoe siamese cats in loaf mode." fig-align="left" style="border-radius:1em"}
:::
...
3. 💬 **Chat**: share your name, where you live, and one thing you’ve made that you’re proud of.
...
-   Fussy YAML indentation: `Code` → `Display` → `Indentation guides:` → `Rainbow lines`

-   Match parentheses: `Code` → `Display` → `Indentation guides:` → Check `Use rainbow parentheses`

-   Matching divs: `R Markdown` → `Advanced` → Check `Use rainbow fenced divs`
