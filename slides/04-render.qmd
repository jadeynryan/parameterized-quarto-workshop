...
2. 💬 **Chat**: if you could have any animal as a pet, what would it be? 🐧🐘🐅🐼🐳
...
3. Ask questions, or take a break.

2. 💬 **Chat**: were any of these functions from the `.qmd` or `.R` files new to you?
