...
💬 **Chat**: what kinds of reports would you like to parameterize? What would
the parameters be?
...
::: incremental
1.  Write report template with default values hard-coded, and then render &
    review.

2.  Set default `params` key-value pairs in YAML. Replace hard-coded values with
    the `params` variables.
