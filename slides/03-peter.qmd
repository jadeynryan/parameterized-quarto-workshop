...
[--\> Take me to the exercises \<--](https://shannonpileggi.github.io/rmedicine-data-cleaning-2023/exercises.html#ph1){target="_blank"}
...
[--\> Take me to the exercises \<--](https://shannonpileggi.github.io/rmedicine-data-cleaning-2023/exercises.html#ph2){target="_blank"}
...
[--\> Take me to the exercises \<--](https://shannonpileggi.github.io/rmedicine-data-cleaning-2023/exercises.html#ph3){target="_blank"}
...
::: {.column width="50%"}
- You want to subset your data (x) by keeping only the ones <br>(y = dead) <br>who are NOT dead.
...
- **Improve** the world
- Send them to Tidy Spreadsheets on YouTube [here](https://www.youtube.com/watch?v=9f-hpJbjKZo) to prevent this in the future.
:::
