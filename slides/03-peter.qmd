...
- If you have the exercise done correctly, click on the Reactions tab in Zoom, and click to put the "thumbs up" emoji `r emo::ji('+1')` on your screen.

- If you are having trouble, click on the Reactions tab in Zoom, and click to put the "raise hand" emoji `r emo::ji('raised')` on your screen.
