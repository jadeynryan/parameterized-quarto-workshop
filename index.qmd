...
`r fontawesome::fa("link")` [pipinghotdata.com](https://www.pipinghotdata.com/)

`r fontawesome::fa("github")` [github.com/shannonpileggi](https://github.com/shannonpileggi/)

`r fontawesome::fa("mastodon")` [@PipingHotData@fosstodon.org](https://fosstodon.org/@PipingHotData)

`r fontawesome::fa("twitter")` [\@PipingHotData](https://twitter.com/PipingHotData)

`r fontawesome::fa("linkedin")` [linkedin.com/in/shannon-m-pileggi/](https://www.linkedin.com/in/shannon-m-pileggi/)
